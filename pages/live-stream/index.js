...
// import  Flvplayer  from "../../components/FlvPlayer/FlvPlayer"
...
function LiveStream() {
  const [streamUrl, setStreamUrl] = useState("http://192.168.70.45:8000/live/rQK9flnZY.flv");
    const handleChange = (e) => {
        setStreamUrl(e.target.value);
  }
  const Player = useCallback(() => <Flvplayer
    url={streamUrl}
